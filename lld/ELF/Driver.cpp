...
static std::tuple<ELFKind, uint16_t, uint8_t> parseEmulation(Ctx &ctx,
  ...
  std::pair<ELFKind, uint16_t> ret =
      StringSwitch<std::pair<ELFKind, uint16_t>>(s)
          ...
          .Case("arcelf", {ELF32LEKind, EM_ARC_COMPACT})
          .Case("arcelfb", {ELF32BEKind, EM_ARC_COMPACT})
          .Case("elf32arc", {ELF32LEKind, EM_ARC_COMPACT})
          .Case("elf32arceb", {ELF32BEKind, EM_ARC_COMPACT})
          .Case("elf32arcv2", {ELF32LEKind, EM_ARC_COMPACT2})
          .Case("elf32arcv2eb", {ELF32BEKind, EM_ARC_COMPACT2})
