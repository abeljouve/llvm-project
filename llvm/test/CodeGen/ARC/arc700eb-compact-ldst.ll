...
; ARCSizeReduction (dossier 05 step 5): general register-relative +
; immediate-offset compact 16-bit load/store (SP-relative was dossier 04;
; PCL-relative/GP-relative are dossiers 04/03, not exercised here).
;
